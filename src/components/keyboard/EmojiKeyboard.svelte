...
<fieldset>
  <legend>Emoji Keyboard <span class='help' on:click={() => displayHelp = !displayHelp}><strong>(?)</strong></span>
  </legend>
...
<WindowContainer title='Emoji Keyboard Help' isModal={true} isDraggable={true} bind:display={displayHelp} showStatusBar={false}
